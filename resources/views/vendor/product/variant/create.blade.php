                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('vendor.variant.index', ['pid' => $product->id]) }}" class="btn btn-primary"><i class="fa fa-reply"></i> Back to variants</a>
                            </div>
                        </div>

                        <form method="post" action="{{ route('vendor.variant.store') }}" enctype="multipart/form-data">
                            @csrf

                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <form method="POST" action="{{ route('vendor.product.destroy', $product) }}">
                                    @csrf
                                    @method('DELETE')
                                    ...
                                    <a href="{{ route('vendor.image-gallery.index', ['pid' => $product->id]) }}" class="btn btn-info"><i class="fa fa-images"></i> Images gallery</a>
                                    <a href="{{ route('vendor.variant.index', ['pid' => $product->id]) }}" class="btn btn-secondary"><i class="fa fa-th-list"></i> Variants</a>
                                    <a href="{{ route('vendor.product.destroy', $product) }}" onclick="event.preventDefault();this.closest('form').submit();" class="btn btn-danger"><i class="fa fa-trash"></i> Delete product</a>
                                </form>
                            </div>
                        </div>

                        <form method="post" action="{{ route('vendor.product.update', $product) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
